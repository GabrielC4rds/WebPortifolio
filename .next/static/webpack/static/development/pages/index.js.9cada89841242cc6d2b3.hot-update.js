...
})(["background:#9c3bf3;width:100%;height:25%;p{font-size:15px;span{font-weight:bold;}}"]);
function index(props) {
  return __jsx(Main, {
    ...
    __self: this
  }, "Get in Touch")), _props_contactTags__WEBPACK_IMPORTED_MODULE_2__["ContactTags"].map(function (res) {
    return __jsx(ContentSubtitle, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 133
      },
...
//# sourceMappingURL=index.js.9cada89841242cc6d2b3.hot-update.js.map